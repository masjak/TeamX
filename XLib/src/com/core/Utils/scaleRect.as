...
package com.core.Utils
{
	...
	/**
	 * adjusts the x, y, width, and height of a rectangle by a scale value.  This is a destructive operation
	 * @param rect
	 * @param scaleX
	 * @param scaleY
	 */
	public function scaleRect(rect:Rectangle, scaleX:Number=1, scaleY:Number=1):void
	{
		rect.x*=scaleX;
		rect.y*=scaleY;
		rect.width*=scaleX;
