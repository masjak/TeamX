...
package com.core.Utils
{
	...
	/**
	 * Acts like modulus but works on negative numbers as well to loop them back towards the top end of the range
	 * @param value
	 * @param range
	 * @return 
	 */
	public function loop(value:Number, range:Number):Number
	{
